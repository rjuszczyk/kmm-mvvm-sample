...
@class NSUserDefaults, SharedSomeItemId, SharedKodein_diDIContext<C>, SharedKodein_diDITrigger, SharedSomeItem, SharedSomeItemsService, SharedSomeItemsResponse, SharedSomeItemNetworkModel, SharedBaseNativeViewModel<Listener, State>, SharedIFeature1ViewModelDisplayedSomeItem, SharedLoadSomeItemsUseCase, SharedIFeature1ViewModelState, SharedBaseViewModel<VM, Listener, State>, SharedFeature1NativeViewModel, SharedIFeature1ViewModelStateFailed, SharedIFeature1ViewModelStateLoaded, SharedLoadSomeItemUseCase, SharedIFeature2ViewModelState, SharedFeature2NativeViewModel, SharedIFeature2ViewModelDisplayedSomeItem, SharedIFeature2ViewModelStateFailed, SharedIFeature2ViewModelStateLoaded, SharedHockeyPlayer, SharedRuntimeQuery<__covariant RowType>, SharedKodein_diDIModule, SharedKodein_typeTypeToken<T>, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinUnit, SharedRuntimeTransacterTransaction, SharedKodein_diDIKey<__contravariant C, __contravariant A, __covariant T>, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing, SharedKotlinx_serialization_coreUpdateMode, SharedKotlinByteArray, SharedKodein_diDIDefinition<C, A, T>, SharedKotlinTriple<__covariant A, __covariant B, __covariant C>, SharedKodein_diSearchSpecs, SharedKodein_diReferenceLocal<__covariant T, __covariant R>, SharedKotlinEnum<E>, SharedKotlinByteIterator, SharedKodein_diScopeRegistry, SharedKodein_diDIDefining<C, A, T>;

@protocol SharedIFeature1ViewModel, SharedFeature1ViewModelDelegate, SharedIFeature2ViewModel, SharedFeature2ViewModelDelegate, SharedKodein_diDI, SharedKodein_diDIAware, SharedDatabase, SharedSomeItemRepository, SharedKotlinx_serialization_coreKSerializer, SharedListenerAware, SharedKotlinx_coroutines_coreFlow, SharedKotlinx_coroutines_coreCoroutineScope, SharedKotlinx_coroutines_coreMutableStateFlow, SharedIFeature1ViewModelListener, SharedBaseViewModelDelegate, SharedIFeature2ViewModelListener, SharedSerializable, SharedPlayerQueries, SharedRuntimeTransactionWithoutReturn, SharedRuntimeTransactionWithReturn, SharedRuntimeTransacter, SharedRuntimeSqlDriver, SharedRuntimeSqlDriverSchema, SharedMultiplatform_settingsSettings, SharedKodein_diDIContainer, SharedKodein_diReference, SharedKotlinLazy, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinx_coroutines_coreFlowCollector, SharedKotlinCoroutineContext, SharedKotlinx_coroutines_coreStateFlow, SharedRuntimeTransactionCallbacks, SharedRuntimeSqlPreparedStatement, SharedRuntimeSqlCursor, SharedRuntimeCloseable, SharedRuntimeQueryListener, SharedKodein_diDIBuilder, SharedKodein_diDITree, SharedKodein_diReferenceMaker, SharedKotlinIterator, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinCoroutineContextElement, SharedKotlinCoroutineContextKey, SharedKodein_diDIBuilderDirectBinder, SharedKodein_diDIBuilderTypeBinder, SharedKodein_diContextTranslator, SharedKodein_diDIBuilderConstantBinder, SharedKodein_diDirectDI, SharedKodein_diDIContainerBuilder, SharedKodein_diDIBindBuilder, SharedKodein_diDIBindBuilderWithContext, SharedKodein_diScope, SharedKodein_diDIBindBuilderWithScope, SharedKodein_diExternalSource, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKotlinKClass, SharedKotlinComparable, SharedKodein_diDIBinding, SharedKodein_diDirectDIAware, SharedKodein_diDirectDIBase, SharedKodein_diBindingDI, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier, SharedKodein_diDIBindingCopier, SharedKodein_diBinding, SharedKodein_diScopeCloseable, SharedKodein_diWithContext;
...
- (id<SharedIFeature1ViewModel>)provideFeature1ViewModelDelegate:(id<SharedFeature1ViewModelDelegate>)delegate __attribute__((swift_name("provideFeature1ViewModel(delegate:)")));
- (id<SharedIFeature2ViewModel>)provideFeature2ViewModelDelegate:(id<SharedFeature2ViewModelDelegate>)delegate someItemId:(SharedSomeItemId *)someItemId __attribute__((swift_name("provideFeature2ViewModel(delegate:someItemId:)")));
@end;
...
- (void)aA:(id<SharedDatabase>)a __attribute__((swift_name("a(a:)")));
@property (readonly) id<SharedKodein_diDI> di __attribute__((swift_name("di")));
@end;
...
- (instancetype)initWithSomeItemsService:(SharedSomeItemsService *)someItemsService __attribute__((swift_name("init(someItemsService:)"))) __attribute__((objc_designated_initializer));
...
@protocol SharedIFeature1ViewModel
@required
...
@interface SharedBaseViewModel<VM, Listener, State> : SharedBase <SharedListenerAware>
- (instancetype)initWithDelegate:(id<SharedBaseViewModelDelegate>)delegate listener:(Listener _Nullable)listener nativeViewModel:(VM)nativeViewModel __attribute__((swift_name("init(delegate:listener:nativeViewModel:)"))) __attribute__((objc_designated_initializer));
- (void)dispose __attribute__((swift_name("dispose()")));
- (void)registerListenerListener:(Listener _Nullable)listener __attribute__((swift_name("registerListener(listener:)")));
- (void)unregisterListener __attribute__((swift_name("unregisterListener()")));
@end;
...
- (instancetype)initWithDelegate:(id<SharedFeature1ViewModelDelegate>)delegate feature1NativeViewModel:(SharedFeature1NativeViewModel *)feature1NativeViewModel __attribute__((swift_name("init(delegate:feature1NativeViewModel:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithDelegate:(id<SharedBaseViewModelDelegate>)delegate listener:(id _Nullable)listener nativeViewModel:(SharedBaseNativeViewModel *)nativeViewModel __attribute__((swift_name("init(delegate:listener:nativeViewModel:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (void)onRetryClicked __attribute__((swift_name("onRetryClicked()")));
- (void)onSomeItemClickedDisplayed:(SharedIFeature1ViewModelDisplayedSomeItem *)displayed __attribute__((swift_name("onSomeItemClicked(displayed:)")));
@end;

__attribute__((swift_name("BaseViewModelDelegate")))
@protocol SharedBaseViewModelDelegate
@required
- (void)consumeStateState:(id _Nullable)state __attribute__((swift_name("consumeState(state:)")));
@end;
...
__attribute__((swift_name("Feature1ViewModelDelegate")))
@protocol SharedFeature1ViewModelDelegate <SharedBaseViewModelDelegate, SharedIFeature1ViewModelListener>
@required
@end;
...
@protocol SharedIFeature2ViewModel
@required
...
- (instancetype)initWithDelegate:(id<SharedFeature2ViewModelDelegate>)delegate feature2NativeViewModel:(SharedFeature2NativeViewModel *)feature2NativeViewModel __attribute__((swift_name("init(delegate:feature2NativeViewModel:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithDelegate:(id<SharedBaseViewModelDelegate>)delegate listener:(id _Nullable)listener nativeViewModel:(SharedBaseNativeViewModel *)nativeViewModel __attribute__((swift_name("init(delegate:listener:nativeViewModel:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (void)onBackClicked __attribute__((swift_name("onBackClicked()")));
- (void)onRetryClicked __attribute__((swift_name("onRetryClicked()")));
@end;
...
__attribute__((swift_name("Feature2ViewModelDelegate")))
@protocol SharedFeature2ViewModelDelegate <SharedBaseViewModelDelegate, SharedIFeature2ViewModelListener>
@required
@end;
